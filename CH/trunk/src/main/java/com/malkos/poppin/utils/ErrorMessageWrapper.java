...
public class ErrorMessageWrapper {
	...
	static{		
		commonErrorsMap.put("Could not send outgoing messages to CH. Reason :Connection refused: connect", new ErrorMessageWraped("We are unable to connect to the Commerce Hub FTP. We will try again shortly and upon establishing a connection we will reprocess any items that were not originally processed.\r\n\r\n",false,false));
		commonErrorsMap.put("Could not send outgoing messages to CH. Reason :connection is closed by foreign host", new ErrorMessageWraped("We are unable to connect to the Commerce Hub FTP. We will try again shortly and upon establishing a connection we will reprocess any items that were not originally processed.\r\n\r\n",false,false));
		commonErrorsMap.put("Could not send outgoing messages to CH. Reason :ftp1.commercehub.com", new ErrorMessageWraped("We are unable to connect to the Commerce Hub FTP. We will try again shortly and upon establishing a connection we will reprocess any items that were not originally processed.\r\n\r\n",false,false));
		commonErrorsMap.put("Could not send outgoing messages to CH. Reason :Connection timed out: connect", new ErrorMessageWraped("We are unable to connect to the Commerce Hub FTP. We will try again shortly and upon establishing a connection we will reprocess any items that were not originally processed.\r\n\r\n",false,false));
		
		commonErrorsMap.put("from remote file manager. Reason: Connection refused: connect", new ErrorMessageWraped("The integration is not able to establish a connection with the EDI Vendor's FTP. We will attempt to connect again shortly.\r\n\r\n",false,false));
		commonErrorsMap.put("from remote file manager. Reason: connection is closed by foreign host", new ErrorMessageWraped("The integration is not able to establish a connection with the EDI Vendor's FTP. We will attempt to connect again shortly.\r\n\r\n",false,false));
		commonErrorsMap.put("from remote file manager. Reason: ftp1.commercehub.com", new ErrorMessageWraped("The integration is not able to establish a connection with the EDI Vendor's FTP. We will attempt to connect again shortly.\r\n\r\n",false,false));
		commonErrorsMap.put("from remote file manager. Reason: Connection timed out: connect", new ErrorMessageWraped("The integration is not able to establish a connection with the EDI Vendor's FTP. We will attempt to connect again shortly.\r\n\r\n",false,false));
