...
public class ErrorMessageWrapper {
	...
	static{		
		...
		commonErrorsMap.put("java.net.ConnectException: Connection timed out: connect", new ErrorMessageWraped("We are unable to connect to the SPS FTP. We will try again shortly and upon establishing a connection we will reprocess any items that were not originally processed.\r\n\r\n",false,false));
