...
public class BarnesAndNobleCrossDockValidator implements IValidator{
	...
	public void validate(PoDocument document) {
		...
		if(document.getShipLocationNumber() != null){
			...
			/*as Barnes and Noble adds leading 0-es to address location number we will convert the value to int*/
			Integer parsedAddressLocation = Integer.parseInt(document.getShipLocationNumber());
			document.setShipLocationNumber(parsedAddressLocation.toString());
