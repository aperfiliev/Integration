...
public class SpsQuillDropShipPoSaxEventHandler extends DefaultHandler implements ISpsDocumentProvider{
	
	private SpsQuillDropShipPoDocument poDocument;
	...
	public SpsQuillDropShipPoSaxEventHandler(RetailerAbstract retailer) {
		this.retailer = retailer;
	}
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException{
		if(qName.equalsIgnoreCase("PurchaseOrder")){
			poDocument = new SpsQuillDropShipPoDocument();
	...
	public void endElement(String uri, String localName, String qName) throws SAXException{
		...
		//meta
			...
			else if(parserIsInAddress == false){
				if(parserIsInContact == true){
			...
			else if(parserIsInAddress == true){
				if(parserIsInShipToAddress){
					if(qName.equalsIgnoreCase("ContactTypeCode"))
